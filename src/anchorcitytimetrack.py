...
class AnchorCityTimeTrack():
    """Convert traceroutes to time tracks with the city of Atlas anchors. These
    time tracks are intended to be used with Atlas anchoring mesh measurements."""
